...
class NormalizedMetric(Base):
    ...
    quality_score: Mapped[float] = mapped_column(Numeric(4, 3), nullable=False, server_default="0.800")
...
class ScoreEvidence(Base):
    ...
    strength: Mapped[float] = mapped_column(Numeric(4, 3), nullable=False)
    impact: Mapped[float] = mapped_column(Numeric(4, 3), nullable=False)
    weight: Mapped[float] = mapped_column(Numeric(6, 3), nullable=False)
    quality: Mapped[float] = mapped_column(Numeric(4, 3), nullable=False)
    contribution_citadel: Mapped[float] = mapped_column(Numeric(8, 3), nullable=False)
    contribution_citrini: Mapped[float] = mapped_column(Numeric(8, 3), nullable=False)
...
class ModuleScore(Base):
    ...
    module_key: Mapped[str] = mapped_column(String(255), nullable=False)
    score_date: Mapped[date] = mapped_column(Date, nullable=False)
    score_citadel: Mapped[float] = mapped_column(Numeric(8, 3), nullable=False)
    score_citrini: Mapped[float] = mapped_column(Numeric(8, 3), nullable=False)
    confidence: Mapped[float] = mapped_column(Numeric(4, 3), nullable=False)
...
class TripwireEvent(Base):
    ...
    decay_factor: Mapped[float] = mapped_column(Numeric(4, 3), nullable=False, server_default="1.000")
